...
BLD_CONFIG_BUILD_NAME="diffutils";
BLD_CONFIG_CONFIG_CMD_ADDL="" #--disable-nls --enable-static
BLD_CONFIG_BUILD_MSVC_RUNTIME_INFO_ADD_TO_C_AND_LDFLAGS=1
#BLD_CONFIG_BUILD_DEBUG=1
BLD_CONFIG_GNU_LIBS_ADDL=( "signal-h" "getopt-gnu" "sigprocmask" "sigpipe" "stdio" "write" "popen" "pclose" )
...
if test 5 -gt 100; then
	...
	if [[ -z $SKIP_STEP || $SKIP_STEP == "checkout" ]]; then
		pacman --noconfirm  -S help2man
		git clone --recurse-submodules https://git.savannah.gnu.org/git/diffutils.git .
