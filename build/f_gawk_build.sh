...
BLD_CONFIG_GNU_LIBS_ADDL=( "fts" "sys_socket" "regex" "random" "flexmember" "setlocale" "locale" "dfa" "sleep" "strsignal" "sys_ioctl" "connect" "listen" "accept" "fnmatch-h" "fnmatch-gnu" "recvfrom" "bind" "setsockopt" "getsockopt" "getopt-gnu" "shutdown" "sys_random" "popen" "pclose" "socket" )

function ourmain() {
	startcommon;
	export CFLAGS=" -I\"$BLD_CONFIG_SRC_FOLDER/pc\"  $CFLAGS"
